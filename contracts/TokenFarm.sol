...
contract TokenFarm  is Ownable {
    ...
    // function addStaker(address _stakerAddress) public {
    //     staker.push(_stakerAddress)
    // }

    // constructor(address _dappTokenAddress) public {
    //     dappTokens = IERC20(_dappTokenAddress);
    // }
    constructor(address _dappTokenAddress) public {
    ...
    function stakeTokens (uint256 _amount, address _token) public {
        require(_amount > 0, "Amount must be creater than 0");
